...
remap('n','<Up>',':resize -2<CR>', { desc = 'decrease window width', silent = true})
remap('n','<Down>',':resize +2<CR>', { desc = 'increase window width', silent = true})
remap('n','<Left>',':vertical resize -2<CR>',{ desc = 'decrease window height', silent = true})
remap('n','<Right>',':vertical resize +2<CR>', { desc = 'increase window height', silent = true})
...
remap("n", "<leader>/", "gcc", { desc = "toggle comment", remap = true })
remap("v", "<leader>/", "gc", { desc = "toggle comment", remap = true })
